                        ...
                        <tr>
                            ...
                            <td class="border-b border-[#ebedf2] p-3 text-center">
                                <button type="button" x-tooltip="Edit">
                                    <a href="{{ route("walikelas.show", $item->slug) }}">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <script>
            async function showAlert(slug) {
                ...
                new window.Swal({
                    ...
                    if (result.value) {
                        try {
                            const response = await fetch(`{{ route("walikelas.destroy", ":slug") }}`.replace(
                                ':slug', slug), {
                                method: 'DELETE',
                                headers: {
            ...
            document.addEventListener('alpine:init', () => {
                ...
                Alpine.data('striped', () => ({
                    init() {
                        ...
                        const datatable5 = new simpleDatatables.DataTable('#walKelTable', tableOptions);
                    },
                }));
            });
        </script>
