     ...
     <div class="flex min-h-screen items-start justify-center px-4" @click.self="open = false">
         <div x-show="open" x-transition x-transition.duration.300
             ...
             <div class="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                 <div class="text-lg font-bold">Tambah Siswa Beprestasi</div>
             ...
             <div class="p-5">
                 <form action="{{ route("prestasi.store") }}" method="POST">
                     ...
                     <div class="mb-3">
                         ...
                         <input id="name" type="text" placeholder="Masukkan Nama Prestasi" class="form-input"
                     ...
                     <div class="mb-3">
                         <label for="description">Deksripsi Prestasi</label>
                         <input id="description" type="text" placeholder="Masukkan Deskripsi" class="form-input"
