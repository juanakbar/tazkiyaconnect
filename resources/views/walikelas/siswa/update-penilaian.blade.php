<x-app-layout>
    ...
    <form class="panel" method="post"method="post" action="{{ route("penilaian_put", $siswa->id) }}">
                    ...
                    <tbody class="dark:text-white-dark">
                        @forelse ($tasks as $item)
                            <tr>
                                ...
                                <td class="w-64">
                                    <input type="hidden" name="task_id[]" id="task_id[]" value="{{ $item->task->id }}">
                                    ...
                                    <input class="form-input w-64" type="text" name="nilai[]" id="nilai[]"
