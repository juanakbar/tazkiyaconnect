            ...
            <div
                ...
                <div
                    ...
                    <div class="absolute top-6 end-6">
                        <a href="/" class="block w-8">
                            <img src="/assets/IconDark.svg" alt="Logo" class="w-full" />
                        </a>
                    </div>
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="email" type="email" placeholder="Enter Email"
                                        class="form-input ps-10 placeholder:text-white-dark" name="email" />
                            ...
                            <div>
                                <label class="flex cursor-pointer items-center" for="remember">
