            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                ...
                <li class="menu nav-item">
                    <a href="{{ route("dashboard") }}"
                        class="nav-link group {{ Route::currentRouteName() === "dashboard" ? "active" : "" }}">
                ...
                @can("SuperAdmin")
                    <li class="menu nav-item">
                        ...
                        <ul x-cloak x-show="activeDropdown === 'master'" x-collapse class="sub-menu text-gray-500">
                            ...
                            <li>
                                <a href="/administrator/khs">Kegiatan</a>
                            </li>
                            <li>
                ...
                @role("WaliKelas")
                    <li class="menu nav-item">
                        <button type="button" class="nav-link group " :class="{ 'active': activeDropdown === 'khs' }"
                            @click="activeDropdown === 'khs' ? activeDropdown = null : activeDropdown = 'khs'">
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Penilaian
                                    KHS</span>
                            </div>
                            <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'khs' }">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <ul x-cloak x-show="activeDropdown === 'khs'" x-collapse class="sub-menu text-gray-500">

                            <li>
                                <a href="/walikelas/kelas-anda">Kelas Anda</a>
                            </li>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('sidebar', () => ({
                ...
                init() {
                    ...
                    //     `.sidebar ul a[href="${formattedRoute}/*/**"]`);
                    // if (selector) {
                    ...
                    // }
                    const currentRoute = {!! json_encode(request()->route()->uri()) !!};
                    const appUrl = '{{ config("app.url") }}:8000'
                    const formattedRoute = '/' +
                        currentRoute.replace(/^\/|\/$/g, '');
                    // console.log(formattedRoute);
                    // Selektor untuk sidebar
                    ...
                    sidebarLinks.forEach(link => {
                        ...
                        // Cek apakah formattedRoute dimulai dengan linkHref
                        if (formattedRoute.startsWith(linkHref)) {
                            console.log(true);
